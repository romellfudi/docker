...
st.set_page_config(page_title='The Machine Learning Hyperparameter Optimization App', page_icon = favicon, layout = 'wide', initial_sidebar_state = 'auto')
hide_st_style = """
            <style>
...
def build_model(df):
    ...
    grid = RandomizedSearchCV(estimator=rf, param_distributions=param_grid, cv=5)
